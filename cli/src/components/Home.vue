	...
	<!--轮播图-->
	 ...
	 <swiper :options="swiperOption" ref="mySwiper">
		 ...
		 <swiper-slide v-for="v in slide" key="v.id">
			 <router-link :to="{name:'page',params:{id:v.lesson_id}}">
				 <img :src="v.thumb" alt="">
			 </router-link>
		 </swiper-slide>
		 <!-- Optional controls -->
		...
		<div id="recommend">
			<router-link :to="{name:'page',params:{id:v.id}}" v-for="v in commendlessons" key="v.id">
				<img :src="v.preview"/>
		...
		<div class="today">
			...
			<div class="pic">
				<router-link :to="{name:'page',params:{id:v.id}}" v-for="v in hotlessons" key="v.id">
					<img :src="v.preview"/>
				</router-link>
			</div>
		</div>
...
//                    direction : 'vertical',
    ...
    mounted() {
        this.getCommendLesson();
        this.getHotLesson();
        this.getSlides();
    },
    methods: {
        getCommendLesson() {
            var api = 'http://video.huangbaovip.com/api/getCommendLesson/4';
...
//                console.log(response.data);
        ...
        getHotLesson() {
            var api = 'http://video.huangbaovip.com/api/getHotLesson/3';
            Vue.axios.get(api).then((response) => {
//                console.log(response.data);
        ...
        getSlides() {
            //获取推荐课程
            var api = 'http://video.huangbaovip.com/api/getSlide';
            Vue.axios.get(api).then((response) => {
//                console.log(response.data);
